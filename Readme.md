...
[![GoDoc](https://godoc.org/github.com/akqp2019/protobuf?status.svg)](http://godoc.org/github.com/akqp2019/protobuf)
...
<a href="https://github.com/akqp2019/protobuf/issues/191">issue</a>
...
Install the protoc-gen-gofast binary
    ...
    go get github.com/akqp2019/protobuf/protoc-gen-gofast

Use it to generate faster marshaling and unmarshaling go code for your protocol buffers.

    protoc --gofast_out=. myproto.proto

This does not allow you to use any of the other gogoprotobuf [extensions](https://github.com/akqp2019/protobuf/blob/master/extensions.md).
...
Installing any of these binaries is easy.  Simply run:
    ...
    go get github.com/akqp2019/protobuf/{binary}
    go get github.com/akqp2019/protobuf/gogoproto

These binaries allow you to use gogoprotobuf [extensions](https://github.com/akqp2019/protobuf/blob/master/extensions.md). You can also use your own binary.

To generate the code, you also need to set the include path properly.

    protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/akqp2019/protobuf/protobuf --{binary}_out=. myproto.proto

To use proto files from "google/protobuf" you need to add additional args to protoc.

    protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/akqp2019/protobuf/protobuf --{binary}_out=\
...
Please visit the [extensions](https://github.com/akqp2019/protobuf/blob/master/extensions.md) page for more documentation.

Install protoc-gen-gogo:

    go get github.com/akqp2019/protobuf/proto
    go get github.com/akqp2019/protobuf/jsonpb
    go get github.com/akqp2019/protobuf/protoc-gen-gogo
    go get github.com/akqp2019/protobuf/gogoproto
...
See [https://github.com/akqp2019/grpc-example](https://github.com/akqp2019/grpc-example) for an example of using gRPC with gogoprotobuf and the wider grpc-ecosystem.
